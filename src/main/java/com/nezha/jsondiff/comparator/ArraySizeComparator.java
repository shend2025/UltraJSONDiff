 ...
 *
 * <code>
 * JSONAssert.assertEquals("{a:[2,6]}", ARRAY_OF_JSONOBJECTS, new ArraySizeComparator(CompareContext.LENIENT));
 * </code>
 *
...
public class ArraySizeComparator extends DefaultComparator {
     ...
     */
    public ArraySizeComparator(CompareContext mode) {
        super(mode);
    }
    ...
    public void compareJSONArray(String prefix, JSONArray expected,
                                 JSONArray actual, JSONCompareDetailResult result) throws JSONException {
